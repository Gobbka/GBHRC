...
auto* panel = new Application::UI::Panel({ -500,0 }, { 200,500 }, { FLOAT_COLORS_BLACK,0.95f });
auto* frls_button_inner = new Application::UI::Panel({ 5,-BUTTON_HEIGHT -5 }, { 190,465 }, { FLOAT_COLORS_BLACK,0.f });
...
void FiendListMarkup(Application::InteractiveForm* form, Application::Render::Engine* pEngine)
{
	...
	frls_topbar_panel->onMouseDown = [](Application::UI::UIElementEventArgs args)
	{
		frls_topbar_panel->get_form()->drag_move(panel);
	};
