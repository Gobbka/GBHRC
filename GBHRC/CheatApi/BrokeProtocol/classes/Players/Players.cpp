...
void BrokeProtocol::Players::ShPlayer::set_position(UnityTypes::Vector3* vector) const
{
	...
	void* params[]{ &vector };
	Mono::mono_runtime_invoke(pSetPosMethod, this->rotationT, params, nullptr);
}

UnityTypes::Vector3* BrokeProtocol::Players::ShPlayer::get_local_position() const
{
	static auto* pGetPosMethod = Mono::mono_property_get_get_method(Mono::mono_class_get_property_from_name(
		Mono::mono_class_from_name(Mono::get_UE_CoreModule(), "UnityEngine", "Transform"),
		"localPosition"
